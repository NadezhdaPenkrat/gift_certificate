...
/**
 * The class that implements CertificateRepository
 * uses JdbcTemplate
...
public class CertificateRepositoryImpl implements CertificateRepository {
    ...
    private static final String UPDATE =
            "update certificate set name = ?, description = ?, " +
    ...
    public Optional<Certificate> getById(Long id) {
        ...
        Optional<Certificate> certificate = jdbcTemplate
                .query(GET_BY_ID, certificateMapper, id)
                .stream()
                .findAny();
        return certificate;
    }
