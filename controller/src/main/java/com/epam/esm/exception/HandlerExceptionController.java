...
public class HandlerExceptionController extends ResponseEntityExceptionHandler {
    ...
    /**
     * Get {@linkValidationException} exception message that contains all validation code errors
     * collect each in ArrayList and find message text from bundle file.
     *
     * @paramexception - {@linkValidationException} exception in validation
     * @returnjson that contains all message errors and codes
     */
    @ExceptionHandler
