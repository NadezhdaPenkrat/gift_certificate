...
public class CertificateMapper implements RowMapper<Certificate> {
    ...
    public Certificate mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        certificate.setCreateDate(ZonedDateTime.ofInstant
                        (rs.getTimestamp("create_date").toInstant(), ZoneOffset.UTC)
                .toLocalDateTime()
        );
        certificate.setUpdateDate(ZonedDateTime.ofInstant
                        (rs.getTimestamp("last_update_date").toInstant(), ZoneOffset.UTC)
                .toLocalDateTime()
        );
